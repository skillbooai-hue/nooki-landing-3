                ...
                <Card className="border-border/60 shadow-md">
                  <CardContent className="p-8">
                    ...
                    <ul className="space-y-3 mb-8">
                      {["15 событий/месяц", "3 семейных пространства", "Автоматические напоминания"].map((feat, i) => (
              ...
              >
                <Card className="border-primary shadow-xl shadow-primary/10 relative overflow-hidden md:scale-105 z-10">
                  ...
                  <CardContent className="p-8">
                    ...
                    <ul className="space-y-3 mb-8">
                      {["Неограниченные события", "Неограниченные пространства", "Интеграция с банком", "Приоритетная поддержка"].map((feat, i) => (
                        <li key={i} className="flex items-center gap-3">
