...
export function CalendarEnLanding() {
                ...
                >
                  <Card className="border-border/50 shadow-md h-full hover:-translate-y-1 transition-transform duration-300">
                    <CardContent className="p-8">
                      <div className={`w-13 h-13 w-12 h-12 rounded-2xl ${f.color} flex items-center justify-center mb-5`}>
                        <f.icon size={24} />
                      </div>
                ...
                <Card className="border-border/60 shadow-md">
                  <CardContent className="p-8">
                    ...
                    <ul className="space-y-3 mb-8">
                      {["15 scheduled events/mo", "3 Family Spaces", "Automatic Reminders"].map((f, i) => (
              ...
              >
                <Card className="border-primary shadow-xl shadow-primary/10 relative overflow-hidden md:scale-105 z-10">
                  ...
                  <CardContent className="p-8">
                    ...
                    <ul className="space-y-3 mb-8">
                      {["Unlimited scheduled events", "Unlimited Family Spaces", "Bank Integration", "Priority Support"].map((f, i) => (
                        <li key={i} className="flex items-center gap-3">
